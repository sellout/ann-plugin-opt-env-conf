# ann-plugin-opt-env-conf

[![Hackage Version](https://img.shields.io/hackage/v/ann-plugin-opt-env-conf)](https://hackage.haskell.org/package/)
[![Packaging status](https://repology.org/badge/tiny-repos/haskell:ann-plugin-opt-env-conf.svg)](https://repology.org/project/haskell:ann-plugin-opt-env-conf/versions)
[![latest packaged versions](https://repology.org/badge/latest-versions/haskell:ann-plugin-opt-env-conf.svg)](https://repology.org/project/haskell:ann-plugin-opt-env-conf/versions)

OptEnvConf for GHC plugins
...
This package is licensed under [The GNU AGPL 3.0 only](./LICENSE). If you need a license for usage that isn’t covered under the AGPL, please contact [Greg Pfeil](mailto:greg@technomadic.org?subject=licensing%20ann-plugin-opt-env-conf).
